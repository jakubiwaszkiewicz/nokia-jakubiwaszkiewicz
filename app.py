...
def home():
    ...
    <h3>Other Sample Data to check</h3>
    <pre>
      ...
      X[900] == [0.0, 4.0, 15.0, 6.0, 0.0, 0.0, 0.0, 0.0, 13.0, 13.0, 1.0, 0.0, 0.0, 7.0, 16.0, 2.0, 0.0, 0.0, 4.0, 15.0, 8.0, 0.0, 5.0, 0.0, 11.0, 14.0, 1.0, 6.0, 16.0, 5.0, 16.0, 14.0, 12.0, 16.0, 16.0, 3.0, 10.0, 12.0, 10.0, 16.0, 10.0, 0.0, 0.0, 6.0, 16.0, 2.0, 0.0, 0.0]
      y[900] == 4

      X[300] == [1.0, 11.0, 16.0, 16.0, 10.0, 0.0, 0.0, 13.0, 14.0, 8.0, 12.0, 11.0, 0.0, 4.0, 0.0, 0.0, 13.0, 4.0, 0.0, 0.0, 0.0, 3.0, 15.0, 0.0, 0.0, 2.0, 15.0, 16.0, 16.0, 9.0, 0.0, 3.0, 13.0, 16.0, 8.0, 1.0, 0.0, 0.0, 7.0, 10.0, 0.0, 0.0, 0.0, 13.0, 3.0, 0.0, 0.0, 0.0]
      y[300] == 7
  </pre>
    """
